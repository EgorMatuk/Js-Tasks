...
console.log(flatten([[true, false, [true, false]], [false, false], [true, true] ]));
...
function canConcatenate(firstArr, secondArrr){
    return firstArr.sort().flat(Infinity).every((value,index) => value === secondArrr[index]? true : false)
}
