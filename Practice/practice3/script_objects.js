...
function fiftyThirtyTwenty(num){
    let object = {"Needs": 0, "Wants": 0, "Savings": 0};
    object.Needs = num/100 * 50;
    object.Wants = num/100 * 30;
    object.Savings = num/100 * 20;
    return object;
}
...
function toArray(obj){
    let arrayReasult = [];
    for(let key in obj){
        arrayReasult.push([key,object[key]]);
    }
    return arrayReasult;
}
...
*/
function matchDifference(object){
    difference = object.wins - object.losing;
    return difference;
}
